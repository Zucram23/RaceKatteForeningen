...
public class CatRepositoryImpl implements CrudRepository<Cat> {
    ...
    public Cat save(Cat cat) {
        ...
        jdbcTemplate.update(sql, cat.getName(), cat.getAge(), cat.getRace().getId(), cat.getOwner().getId());
        return cat;
    }
    ...
    public void update(Cat cat){
        ...
        jdbcTemplate.update(sql, cat.getName(), cat.getAge(), cat.getRace().getId(), cat.getOwner().getId(), cat.getId());
    }
